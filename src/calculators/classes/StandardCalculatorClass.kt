...
abstract class StandardCalculatorClass: StandardCalculator {
	...
	override fun minus(num1: Number, num2: Number): Number {
		...
		if(num1 is Double) { // Number 1 is a Double
			...
			if(num2 is Double) { // Number 1 and Number 2 are Doubles
				...
				addOperationAndResultToHistory(num1, StandardCalculatorOperations.Minus.operationSymbol, num2, result)
	...
	override fun div(num1: Number, num2: Number): Number {
		...
		if(num2 == 0) { // Throws a Divisor Can't Be Zero (0)
			
		}
		else { // The divisor it's supported
			...
			if(num1 is Double) { // Number 1 is a Double
				...
				if(num2 is Double) { // Number 1 and Number 2 are Doubles
					...
					addOperationAndResultToHistory(num1, StandardCalculatorOperations.Obelus.operationSymbol, num2, result)
